...
<asp:Content ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="map-wrap">
        <map:GoogleMap ID="GoogleMap1" runat="server" Latitude="42.1229" Longitude="24.7879"
            Zoom="12" EnableScrollWheelZoom="true" CssClass="map"  Width="100%" Height="600px" FullscreenControl="true">
        </map:GoogleMap>
        <map:GoogleMarkers ID="GoogleMarkers1" TargetControlID="GoogleMap1" runat="server"
            ...
            <Markers>
                <map:Marker Position-Latitude="42.132" Position-Longitude="24.75" Title="Click on the marker"
