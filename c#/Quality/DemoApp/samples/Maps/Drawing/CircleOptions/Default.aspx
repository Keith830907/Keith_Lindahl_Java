<%@ Page Language="C#" AutoEventWireup="false" MasterPageFile="../../Maps.master" CodeBehind="Default.aspx.cs" Inherits="GoogleMaps.Samples.Maps.Drawing.CircleOptions.Default" %>

<asp:Content ContentPlaceHolderID="MainContent" runat="server">
    <div class="jumbotron">
        <h2>Drawing Circle Options Sample</h2>
        <p>A sample about ASP.NET Google Map Control drawing circle options.</p>
    </div>
    <p>
    ...
    <div class="map-wrap">
        ...
        <map:DrawingManager ID="GoogleManager1" TargetControlID="GoogleMap1" runat="server" DrawingMode="CIRCLE">
            <DrawingControlOptions DrawingModes="circle" Position="TopLeft" />
            <CircleOptions Clickable="true" Draggable="true" Editable="true" FillColor="Blue" StrokeColor="Red" />
        </map:DrawingManager>
    </div>
    <%--CODE--%>
    <hr />
