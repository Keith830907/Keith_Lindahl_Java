<%@ Page Title="" Language="C#" MasterPageFile="../Maps.master" AutoEventWireup="false" CodeBehind="Default.aspx.cs" Inherits="GoogleMaps.Samples.Maps.UpdatePanel.Default" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="jumbotron">
        <h2>Inside UpdatePanel Sample</h2>
        <p>
            A sample about ASP.NET Google Map Control been placed inside an MS Ajax UpdatePanel.
        </p>
    </div>
    <p>
        GoogleMap control works fine inside update panel.
        <br />
        That could be used to update map and avoid "page flickering".
    </p>
            ...
            <asp:FormView ID="fvOptions" runat="server" DefaultMode="Edit" ItemType="GoogleMaps.GoogleMap" SelectMethod="GetMap" UpdateMethod="UpdateMap" Width="100%">
                <EditItemTemplate>
                    ...
                    <div style="text-align: center;">
                        <asp:Button runat="server" Text="Show" CommandName="Update" />
                    </div>
