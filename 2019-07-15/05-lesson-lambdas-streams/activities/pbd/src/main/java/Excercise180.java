...
//    Create an ArrayList of Integers. Fill up the list with 1,000 random numbers, each from 10 to 99. Then display
//    the contents of the ArrayList on the screen in any way you like.
//
