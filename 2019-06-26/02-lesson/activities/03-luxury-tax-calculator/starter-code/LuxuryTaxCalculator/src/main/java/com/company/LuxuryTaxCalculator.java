...
public class LuxuryTaxCalculator {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Please enter a salary for Player 1 (without the dollar sign or commas): ");
        ...
        System.out.format("The total of all three players salaries are: " + "%.2fM", total);
        double luxury_tax =0.18;
        if (total < 40000000) {
            taxPayable = 0;
            System.out.format("The total is (no tax): " + "%.2fM", total);
        } else if (total > 40000000) {
            taxPayable = (total - 40000000) * luxury_tax;
            System.out.format("The total is plus tax: " + "%.2fM", total + taxPayable);
            }
    }
}
